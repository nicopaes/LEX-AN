...
{
  "$end", "error", "$undefined", "\"ENTRADA\"", "\"Variable\"",
  "\"SAIDA\"", "\"FIM\"", "\"FACA\"", "\"INC\"", "\"ZERA\"",
  "\"ENQUANTO\"", "\",\"", "\"(\"", "\")\"", "\"=\"", "\"End of Program\"",
  "$accept", "Program", "$@1", "$@2", "varlist", "$@3", "cmds", "cmd",
  "$@4", YY_NULLPTR
};
#endif
...
{
     -19,   -19,   -19,   -19,    -7,   -19,   -18,   -19,   -19
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,    10,     6,     7,    17,    18,    31
};
...
#line 41 "prov.y"
                 {change_isEntrada(1);}
#line 1453 "prov.tab.c"
    break;

  case 3:
#line 41 "prov.y"
                                                      {change_isEntrada(0);}
#line 1459 "prov.tab.c"
    break;
...
#line 1497 "prov.tab.c"
    break;

  case 11:
#line 67 "prov.y"
           {push_fim();}
#line 1503 "prov.tab.c"
    break;
...
#line 1545 "prov.tab.c"
    break;


#line 1549 "prov.tab.c"
